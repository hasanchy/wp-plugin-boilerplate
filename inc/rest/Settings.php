...
class Settings
{
    ...
    public function save_settings($req) {
        ...
        if ( isset( $req['data'] ) ) {
            ...
            return new WP_Error('rest_wpplugbp_api_settings', 'Pixel data is required', ['status' => 400]);
        }
    ...
    {
        $permit = \WPPLUGBP\rest\Settings::permit();
    ...
    public static function permit($cap = 'publish_posts')
    {
        if (!\current_user_can($cap)) {
            return new WP_Error('rest_wpplugbp_forbidden', \__('Forbidden'), ['status' => 403]);
        }
        return null;
    }
