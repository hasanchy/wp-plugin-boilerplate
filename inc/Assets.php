...
class Assets {
	...
	public function enqueue_scripts_and_styles() {
		...
		$handle = $this->enqueueScript( 'wpplugbp-admin', 'admin.js', array( 'wp-element' ) );
	...
	public function enqueueScript( $handle, $src, $deps = array(), $in_footer = \true, $isLib = \false ) {
		return $this->enqueue( $handle, $src, $deps, $isLib, 'script', $in_footer );
	}

	protected function enqueue( $handle, $src, $deps = array(), $isLib = \false, $type = 'script', $in_footer = \true, $media = 'all' ) {
