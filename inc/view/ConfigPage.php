...
class ConfigPage
{
    ...
    {
        \add_menu_page('WP Plugin Boilerplate', 'WP Plugin Boilerplate', 'manage_options', 'wp-plugin-boilerplate', [$this, 'render_component_library'], 'dashicons-grid-view', 100);
    }
    ...
    {
		register_block_type( WPPLUGBP_PATH . '/build', array(
    ...
    public function theHTML($attributes) {
        ...
        $pixel_data = ($wpplugbp_pixel_data) ? unserialize( $wpplugbp_pixel_data ) : [];
        $aspect_ratio = 320;
